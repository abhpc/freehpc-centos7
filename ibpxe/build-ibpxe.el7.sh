...
# Revise src codes
\cp -Rf ibpxe.el7.src.cpp ibpxe.cpp
...
mkdir -p /var/www/html/abhpc/ibpxe
mv -f ibpxe /var/www/html/abhpc/ibpxe/ibpxe-${des_guid}.el7
chmod 755 /var/www/html/abhpc/ibpxe/ibpxe-${des_guid}.el7
rm -rf ibpxe.cpp