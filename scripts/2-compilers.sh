...
prepend-path    PATH            $GCC_DIR/gcc-$GCC_VERS/bin
prepend-path    LD_LIBRARY_PATH $GCC_DIR/gcc-$GCC_VERS/lib64
prepend-path    LIBRARY_PATH    $GCC_DIR/gcc-$GCC_VERS/lib64
prepend-path    MANPATH         $GCC_DIR/gcc-$GCC_VERS/share/man
EOF
